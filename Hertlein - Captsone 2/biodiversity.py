...
sheep_species = species[(species.is_sheep) & (species.category == 'Mammal')].reset_index()
sheep_species
...
# Minimum detectable effect is 33% so from optimizely we need 520 samples
...
# We would require 2.08 weeks at Bryce and 1.03 weeks at Yellowstone National Park to observe enough sheep for accurate results.
